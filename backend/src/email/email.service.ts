...
export class EmailService {
  ...
  async sendSubmissionNotification(report: ExpenseReport, manager: User) {
    ...
    const html = `<p>Hello ${manager.full_name},</p><p>${report.user.full_name} has submitted an expense report titled "<b>${report.title}</b>" for your approval.</p><p>Please log in to the ExpenseBeast system to review it.</p>`;
